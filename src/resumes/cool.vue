  ...
  <div class="resume">
    <div class="banner">
      <div style="float:left">
        ...
        <!--<div class="banner__location">{{person.birth.year}} - {{person.birth.location}}</div>-->
        <div class="banner__location">35 Años</div>
      </div>
      <div style="float:right; margin-top: -19px;">
        {{ lang.contact }}
            ...
            <a
              ...
              <i class="section-link__icon fa fa-linkedin"></i>Digna Marquez
            </a>
        <!--linkedin-->
    ...
    <div class="content">
      <div class="content__left">
        <div class="section">
          <div
            ...
            <div class="section-content-grid" v-for="(project, index) in person.projects" :key="index">
              <a
      ...
      <div class="content__right">
        ...
        <div
          ...
          class="section">
          <div class="section-headline">
            <i class="section-headline__icon material-icons">done_all</i>{{ lang.skills }}
          </div>
